...
import { BeanFactoryDefinition, ExpressionDefinition, RestDefinition, RouteConfigurationDefinition, FromDefinition, RouteTemplateDefinition } from '../model/CamelDefinition';
...
export declare class CamelDefinitionApiExt {
    ...
    static addRouteTemplateToIntegration: (integration: Integration, routeTemplate: RouteTemplateDefinition) => Integration;
    static deleteRouteTemplateFromIntegration: (integration: Integration, routeTemplate: RouteTemplateDefinition) => Integration;
