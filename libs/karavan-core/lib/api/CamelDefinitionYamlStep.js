...
export class CamelDefinitionYamlStep {
    static readProcessorDefinition = (element) => {
    ...
    static readOutputAwareFromDefinition = (element) => {
    ...
    static readAggregateDefinition = (element) => {
    ...
    static readChoiceDefinition = (element) => {
        ...
        def.when = element && element?.when ? element?.when.map((x) => CamelDefinitionYamlStep.readWhenDefinition(x)) : [];
        return def;
    };
    static readCircuitBreakerDefinition = (element) => {
    ...
    static readDelayDefinition = (element) => {
        ...
        if (element?.expression !== undefined) {
            ...
            const languageName = Object.keys(element).filter(key => CamelMetadataApi.hasLanguage(key))[0] || undefined;
            if (languageName) {
                const exp = {};
    ...
    static readDynamicRouterDefinition = (element) => {
    ...
    static readEnrichDefinition = (element) => {
    ...
    static readErrorHandlerDefinition = (element) => {
    ...
    static readExpressionSubElementDefinition = (element) => {
    ...
    static readFinallyDefinition = (element) => {
        let def = element ? new FinallyDefinition({ ...element }) : new FinallyDefinition();
        def.steps = CamelDefinitionYamlStep.readSteps(element?.steps);
        return def;
    };
    static readFromDefinition = (element) => {
        if (element && typeof element === 'string')
            element = { uri: element };
    ...
    static readGlobalOptionDefinition = (element) => {
        let def = element ? new GlobalOptionDefinition({ ...element }) : new GlobalOptionDefinition();
        return def;
    };
    static readGlobalOptionsDefinition = (element) => {
        let def = element ? new GlobalOptionsDefinition({ ...element }) : new GlobalOptionsDefinition();
        def.globalOption = element && element?.globalOption ? element?.globalOption.map((x) => CamelDefinitionYamlStep.readGlobalOptionDefinition(x)) : [];
        return def;
    };
    static readIdempotentConsumerDefinition = (element) => {
    ...
    static readInputTypeDefinition = (element) => {
        let def = element ? new InputTypeDefinition({ ...element }) : new InputTypeDefinition();
        return def;
    };
    static readInterceptDefinition = (element) => {
    ...
    static readInterceptFromDefinition = (element) => {
    ...
    static readInterceptSendToEndpointDefinition = (element) => {
        if (element && typeof element === 'string')
            element = { uri: element };
    ...
    static readKameletDefinition = (element) => {
        if (element && typeof element === 'string')
            element = { name: element };
        let def = element ? new KameletDefinition({ ...element }) : new KameletDefinition();
        return def;
    };
    static readLoadBalanceDefinition = (element) => {
    ...
    static readLogDefinition = (element) => {
        if (element && typeof element === 'string')
            element = { message: element };
        let def = element ? new LogDefinition({ ...element }) : new LogDefinition();
        return def;
    };
    static readLoopDefinition = (element) => {
    ...
    static readMarshalDefinition = (element) => {
    ...
    static readMulticastDefinition = (element) => {
        let def = element ? new MulticastDefinition({ ...element }) : new MulticastDefinition();
        def.steps = CamelDefinitionYamlStep.readSteps(element?.steps);
        return def;
    };
    static readOnCompletionDefinition = (element) => {
    ...
    static readOnExceptionDefinition = (element) => {
    ...
    static readOnFallbackDefinition = (element) => {
        let def = element ? new OnFallbackDefinition({ ...element }) : new OnFallbackDefinition();
        def.steps = CamelDefinitionYamlStep.readSteps(element?.steps);
        return def;
    };
    static readOnWhenDefinition = (element) => {
    ...
    static readPollEnrichDefinition = (element) => {
    ...
    static readRecipientListDefinition = (element) => {
    ...
    static readResilience4jConfigurationDefinition = (element) => {
        let def = element ? new Resilience4jConfigurationDefinition({ ...element }) : new Resilience4jConfigurationDefinition();
        return def;
    };
    static readRestContextRefDefinition = (element) => {
        if (element && typeof element === 'string')
            element = { ref: element };
        let def = element ? new RestContextRefDefinition({ ...element }) : new RestContextRefDefinition();
        return def;
    };
    static readResumableDefinition = (element) => {
        let def = element ? new ResumableDefinition({ ...element }) : new ResumableDefinition();
        return def;
    };
    static readRollbackDefinition = (element) => {
        let def = element ? new RollbackDefinition({ ...element }) : new RollbackDefinition();
        return def;
    };
    static readRouteBuilderDefinition = (element) => {
        if (element && typeof element === 'string')
            element = { ref: element };
        let def = element ? new RouteBuilderDefinition({ ...element }) : new RouteBuilderDefinition();
        return def;
    };
    static readRouteConfigurationContextRefDefinition = (element) => {
        if (element && typeof element === 'string')
            element = { ref: element };
        let def = element ? new RouteConfigurationContextRefDefinition({ ...element }) : new RouteConfigurationContextRefDefinition();
        return def;
    };
    static readRouteConfigurationDefinition = (element) => {
        let def = element ? new RouteConfigurationDefinition({ ...element }) : new RouteConfigurationDefinition();
        def.onCompletion = element && element?.onCompletion ? element?.onCompletion.map((x) => CamelDefinitionYamlStep.readOnCompletionDefinition(x.onCompletion)) : [];
        def.interceptSendToEndpoint = element && element?.interceptSendToEndpoint ? element?.interceptSendToEndpoint.map((x) => CamelDefinitionYamlStep.readInterceptSendToEndpointDefinition(x.interceptSendToEndpoint)) : [];
        def.intercept = element && element?.intercept ? element?.intercept.map((x) => CamelDefinitionYamlStep.readInterceptDefinition(x.intercept)) : [];
        ...
        def.onException = element && element?.onException ? element?.onException.map((x) => CamelDefinitionYamlStep.readOnExceptionDefinition(x.onException)) : [];
        def.interceptFrom = element && element?.interceptFrom ? element?.interceptFrom.map((x) => CamelDefinitionYamlStep.readInterceptFromDefinition(x.interceptFrom)) : [];
        return def;
    };
    static readRouteContextRefDefinition = (element) => {
        if (element && typeof element === 'string')
            element = { ref: element };
        let def = element ? new RouteContextRefDefinition({ ...element }) : new RouteContextRefDefinition();
        return def;
    };
    static readRouteDefinition = (element) => {
    ...
    static readRouteTemplateDefinition = (element) => {
        ...
        def.beans = element && element?.beans ? element?.beans.map((x) => CamelDefinitionYamlStep.readBeanFactoryDefinition(x)) : [];
        if (element?.from !== undefined) {
            if (Array.isArray(element.from)) {
                def.from = CamelDefinitionYamlStep.readFromDefinition(element.from[0]);
            }
        ...
        def.parameters = element && element?.parameters ? element?.parameters.map((x) => CamelDefinitionYamlStep.readRouteTemplateParameterDefinition(x)) : [];
        return def;
    };
    static readRouteTemplateParameterDefinition = (element) => {
        let def = element ? new RouteTemplateParameterDefinition({ ...element }) : new RouteTemplateParameterDefinition();
        return def;
    };
    static readRoutingSlipDefinition = (element) => {
    ...
    static readSagaActionUriDefinition = (element) => {
        if (element && typeof element === 'string')
            element = { uri: element };
    ...
    static readSagaDefinition = (element) => {
        let def = element ? new SagaDefinition({ ...element }) : new SagaDefinition();
        def.steps = CamelDefinitionYamlStep.readSteps(element?.steps);
        def.option = element && element?.option ? element?.option.map((x) => CamelDefinitionYamlStep.readPropertyExpressionDefinition(x)) : [];
        return def;
    };
    static readSamplingDefinition = (element) => {
        let def = element ? new SamplingDefinition({ ...element }) : new SamplingDefinition();
        return def;
    };
    static readScriptDefinition = (element) => {
    ...
    static readSetBodyDefinition = (element) => {
    ...
    static readSetHeadersDefinition = (element) => {
        let def = element ? new SetHeadersDefinition({ ...element }) : new SetHeadersDefinition();
        def.headers = element && element?.headers ? element?.headers.map((x) => CamelDefinitionYamlStep.readSetHeaderDefinition(x)) : [];
        return def;
    };
    static readSetPropertyDefinition = (element) => {
    ...
    static readSetVariableDefinition = (element) => {
    ...
    static readSetVariablesDefinition = (element) => {
        let def = element ? new SetVariablesDefinition({ ...element }) : new SetVariablesDefinition();
        def.variables = element && element?.variables ? element?.variables.map((x) => CamelDefinitionYamlStep.readSetVariableDefinition(x)) : [];
        return def;
    };
    static readSortDefinition = (element) => {
    ...
    static readSplitDefinition = (element) => {
    ...
    static readToDynamicDefinition = (element) => {
        if (element && typeof element === 'string')
            element = { uri: element };
    ...
    static readTokenizerDefinition = (element) => {
    ...
    static readTryDefinition = (element) => {
        ...
        def.doCatch = element && element?.doCatch ? element?.doCatch.map((x) => CamelDefinitionYamlStep.readCatchDefinition(x)) : [];
        def.steps = CamelDefinitionYamlStep.readSteps(element?.steps);
        return def;
    };
    static readUnmarshalDefinition = (element) => {
    ...
    static readValidateDefinition = (element) => {
    ...
    static readValueDefinition = (element) => {
        let def = element ? new ValueDefinition({ ...element }) : new ValueDefinition();
        return def;
    };
    static readWhenDefinition = (element) => {
    ...
    static readWireTapDefinition = (element) => {
        let def = element ? new WireTapDefinition({ ...element }) : new WireTapDefinition();
        def = ComponentApi.parseElementUri(def);
        return def;
    };
    static readBeanConstructorDefinition = (element) => {
        let def = element ? new BeanConstructorDefinition({ ...element }) : new BeanConstructorDefinition();
        return def;
    };
    static readBeanConstructorsDefinition = (element) => {
        let def = element ? new BeanConstructorsDefinition({ ...element }) : new BeanConstructorsDefinition();
        def.constructor = element && element?.constructor ? element?.constructor.map((x) => CamelDefinitionYamlStep.readBeanConstructorDefinition(x)) : [];
        return def;
    };
    static readBeanPropertiesDefinition = (element) => {
        let def = element ? new BeanPropertiesDefinition({ ...element }) : new BeanPropertiesDefinition();
        def.property = element && element?.property ? element?.property.map((x) => CamelDefinitionYamlStep.readBeanPropertyDefinition(x)) : [];
        return def;
    };
    static readBeanPropertyDefinition = (element) => {
    ...
    static readDefaultErrorHandlerDefinition = (element) => {
    ...
    static readJtaTransactionErrorHandlerDefinition = (element) => {
    ...
    static readXQueryExpression = (element) => {
        if (element && typeof element === 'string')
            element = { expression: element };
    ...
    static readTopicLoadBalancerDefinition = (element) => {
        let def = element ? new TopicLoadBalancerDefinition({ ...element }) : new TopicLoadBalancerDefinition();
        return def;
    };
    static readWeightedLoadBalancerDefinition = (element) => {
        let def = element ? new WeightedLoadBalancerDefinition({ ...element }) : new WeightedLoadBalancerDefinition();
        return def;
    };
    static readApiKeyDefinition = (element) => {
        let def = element ? new ApiKeyDefinition({ ...element }) : new ApiKeyDefinition();
        return def;
    };
    static readBasicAuthDefinition = (element) => {
        let def = element ? new BasicAuthDefinition({ ...element }) : new BasicAuthDefinition();
        return def;
    };
    static readBearerTokenDefinition = (element) => {
        let def = element ? new BearerTokenDefinition({ ...element }) : new BearerTokenDefinition();
        return def;
    };
    static readDeleteDefinition = (element) => {
        let def = element ? new DeleteDefinition({ ...element }) : new DeleteDefinition();
        def.security = element && element?.security ? element?.security.map((x) => CamelDefinitionYamlStep.readSecurityDefinition(x)) : [];
        def.param = element && element?.param ? element?.param.map((x) => CamelDefinitionYamlStep.readParamDefinition(x)) : [];
        def.responseMessage = element && element?.responseMessage ? element?.responseMessage.map((x) => CamelDefinitionYamlStep.readResponseMessageDefinition(x)) : [];
        return def;
    };
    static readGetDefinition = (element) => {
    ...
    static readHeadDefinition = (element) => {
    ...
    static readMutualTLSDefinition = (element) => {
        let def = element ? new MutualTLSDefinition({ ...element }) : new MutualTLSDefinition();
        return def;
    };
    static readOAuth2Definition = (element) => {
        let def = element ? new OAuth2Definition({ ...element }) : new OAuth2Definition();
        def.scopes = element && element?.scopes ? element?.scopes.map((x) => CamelDefinitionYamlStep.readRestPropertyDefinition(x)) : [];
        return def;
    };
    static readOpenApiDefinition = (element) => {
        let def = element ? new OpenApiDefinition({ ...element }) : new OpenApiDefinition();
        return def;
    };
    static readOpenIdConnectDefinition = (element) => {
        let def = element ? new OpenIdConnectDefinition({ ...element }) : new OpenIdConnectDefinition();
        return def;
    };
    static readParamDefinition = (element) => {
        let def = element ? new ParamDefinition({ ...element }) : new ParamDefinition();
        def.examples = element && element?.examples ? element?.examples.map((x) => CamelDefinitionYamlStep.readRestPropertyDefinition(x)) : [];
        return def;
    };
    static readPatchDefinition = (element) => {
    ...
    static readPostDefinition = (element) => {
    ...
    static readPutDefinition = (element) => {
    ...
    static readResponseHeaderDefinition = (element) => {
        let def = element ? new ResponseHeaderDefinition({ ...element }) : new ResponseHeaderDefinition();
        return def;
    };
    static readResponseMessageDefinition = (element) => {
        let def = element ? new ResponseMessageDefinition({ ...element }) : new ResponseMessageDefinition();
        def.examples = element && element?.examples ? element?.examples.map((x) => CamelDefinitionYamlStep.readRestPropertyDefinition(x)) : [];
        def.header = element && element?.header ? element?.header.map((x) => CamelDefinitionYamlStep.readResponseHeaderDefinition(x)) : [];
        return def;
    };
    static readRestBindingDefinition = (element) => {
        let def = element ? new RestBindingDefinition({ ...element }) : new RestBindingDefinition();
        return def;
    };
    static readRestConfigurationDefinition = (element) => {
        let def = element ? new RestConfigurationDefinition({ ...element }) : new RestConfigurationDefinition();
        def.corsHeaders = element && element?.corsHeaders ? element?.corsHeaders.map((x) => CamelDefinitionYamlStep.readRestPropertyDefinition(x)) : [];
        def.dataFormatProperty = element && element?.dataFormatProperty ? element?.dataFormatProperty.map((x) => CamelDefinitionYamlStep.readRestPropertyDefinition(x)) : [];
        def.consumerProperty = element && element?.consumerProperty ? element?.consumerProperty.map((x) => CamelDefinitionYamlStep.readRestPropertyDefinition(x)) : [];
        def.endpointProperty = element && element?.endpointProperty ? element?.endpointProperty.map((x) => CamelDefinitionYamlStep.readRestPropertyDefinition(x)) : [];
        def.apiProperty = element && element?.apiProperty ? element?.apiProperty.map((x) => CamelDefinitionYamlStep.readRestPropertyDefinition(x)) : [];
        def.componentProperty = element && element?.componentProperty ? element?.componentProperty.map((x) => CamelDefinitionYamlStep.readRestPropertyDefinition(x)) : [];
        return def;
    };
    static readRestDefinition = (element) => {
        let def = element ? new RestDefinition({ ...element }) : new RestDefinition();
        def.head = element && element?.head ? element?.head.map((x) => CamelDefinitionYamlStep.readHeadDefinition(x)) : [];
        def.patch = element && element?.patch ? element?.patch.map((x) => CamelDefinitionYamlStep.readPatchDefinition(x)) : [];
        ...
        def.post = element && element?.post ? element?.post.map((x) => CamelDefinitionYamlStep.readPostDefinition(x)) : [];
        def.securityRequirements = element && element?.securityRequirements ? element?.securityRequirements.map((x) => CamelDefinitionYamlStep.readSecurityDefinition(x)) : [];
        def.get = element && element?.get ? element?.get.map((x) => CamelDefinitionYamlStep.readGetDefinition(x)) : [];
        ...
        def.delete = element && element?.delete ? element?.delete.map((x) => CamelDefinitionYamlStep.readDeleteDefinition(x)) : [];
        def.put = element && element?.put ? element?.put.map((x) => CamelDefinitionYamlStep.readPutDefinition(x)) : [];
        return def;
    };
    static readRestPropertyDefinition = (element) => {
        let def = element ? new RestPropertyDefinition({ ...element }) : new RestPropertyDefinition();
        return def;
    };
    static readRestSecuritiesDefinition = (element) => {
    ...
    static readValidatorsDefinition = (element) => {
    ...
    static readStep = (body, clone = false) => {
